...
static SWIFT_C_INLINE_THUNK void
swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16(char *_Nonnull result,
                                                                           struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16 value) {
    memcpy(result + 0, &value._1, 8);
    memcpy(result + 8, &value._2, 8);
}
...
static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8
swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(const char *_Nonnull value) {
    struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 result;
    memcpy(&result._1, value + 0, 8);
    return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16
$s20KFirebaseAuthInterop16ActionCodeResultO11descriptionSSvg(
        struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
...
static SWIFT_C_INLINE_THUNK void
swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8(char *_Nonnull result,
                                                             struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8 value) {
    memcpy(result + 0, &value._1, 8);
}
...
static SWIFT_C_INLINE_THUNK void
swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9(char *_Nonnull result,
                                                                         struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9 value) {
    memcpy(result + 0, &value._1, 8);
    memcpy(result + 8, &value._2, 1);
}

SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9
$s20KFirebaseAuthInterop16ActionCodeResultO8rawValueACSgSi_tcfC(
        ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
SWIFT_EXTERN ptrdiff_t $s20KFirebaseAuthInterop16ActionCodeResultO8rawValueSivg(
        struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16
$s20KFirebaseAuthInterop0B8ProviderO11stringValueSSyF(
        struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // stringValue()
SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9
$s20KFirebaseAuthInterop0B8ProviderO8rawValueACSgSi_tcfC(
        ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
SWIFT_EXTERN ptrdiff_t $s20KFirebaseAuthInterop0B8ProviderO8rawValueSivg(
        struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
