...
typedef SWIFT_ENUM(NSInteger, ActionCodeResult, closed) {
  ActionCodeResultSignInWithEmailLink = 0,
  ActionCodeResultVerifyEmail = 1,
  ActionCodeResultRecoverEmail = 2,
  ActionCodeResultRevertSecondFactorAddition = 3,
  ActionCodeResultVerifyBeforeChangeEmail = 4,
};

@class NSNumber;
@class NSError;
SWIFT_CLASS("_TtC20KFirebaseAuthInterop23ActionCodeResultWrapper")
@interface ActionCodeResultWrapper : NSObject
@property (nonatomic, strong) NSNumber * _Nullable result;
@property (nonatomic, strong) NSError * _Nullable error;
- (nonnull instancetype)initWithResult:(NSNumber * _Nullable)result error:(NSError * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class NSString;
enum AuthProvider : NSInteger;
SWIFT_CLASS("_TtC20KFirebaseAuthInterop15AuthCredentials")
...
@property (nonatomic) enum AuthProvider provider;
- (nonnull instancetype)initWithIdToken:(NSString * _Nonnull)idToken accessToken:(NSString * _Nonnull)accessToken provider:(enum AuthProvider)provider OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, AuthProvider, closed) {
  AuthProviderGoogle = 0,
  AuthProviderFacebook = 1,
};
...
- (void)getClientIdWithCompletion:(void (^ _Nonnull)(NSString * _Nullable))completion;
- (void)addListenerAuthStateChangeWithCompletion:(void (^ _Nonnull)(UserModel * _Nullable))completion;
- (void)removeListenerAuthStateChange;
- (void)addListenerIdTokenChangedWithCompletion:(void (^ _Nonnull)(UserModel * _Nullable))completion;
- (void)removeListenerIdTokenChanged;
- (void)signInAnonymouslyWithCompletion:(void (^ _Nonnull)(UserModel * _Nullable, NSError * _Nullable))completion;
- (void)createUserWithEmailAndPasswordWithEmail:(NSString * _Nonnull)email password:(NSString * _Nonnull)password completion:(void (^ _Nonnull)(UserModel * _Nullable, NSError * _Nullable))completion;
- (void)signInWithEmail:(NSString * _Nonnull)email password:(NSString * _Nonnull)password completion:(void (^ _Nonnull)(UserModel * _Nullable, NSError * _Nullable))completion;
- (void)updatePasswordWithNewPassword:(NSString * _Nonnull)newPassword completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
- (void)setLanguageCodeLocaleWithLanguageCode:(NSString * _Nonnull)languageCode;
- (NSString * _Nullable)getLanguageCodeLocale SWIFT_WARN_UNUSED_RESULT;
- (void)updateProfileWithDisplayName:(NSString * _Nullable)displayName photoURL:(NSURL * _Nullable)photoURL completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)isLinkEmailWithEmail:(NSString * _Nonnull)email completion:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completion;
- (void)applyActionWithCodeWithCode:(NSString * _Nonnull)code completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)checkActionWithCodeWithCode:(NSString * _Nonnull)code completion:(void (^ _Nonnull)(ActionCodeResultWrapper * _Nullable))completion;
- (void)sendPasswordResetWithEmail:(NSString * _Nonnull)email completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)deleteCurrentUserWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)logoutWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (UserModel * _Nullable)getCurrentUser SWIFT_WARN_UNUSED_RESULT;
- (void)sendOtpWithPhoneNumber:(NSString * _Nonnull)phoneNumber onCodeSent:(void (^ _Nonnull)(NSString * _Nonnull))onCodeSent onCodeSentFailed:(void (^ _Nonnull)(NSError * _Nonnull))onCodeSentFailed;
- (void)verifyOtpWithVerificationId:(NSString * _Nonnull)verificationId otpCode:(NSString * _Nonnull)otpCode onVerificationCompleted:(void (^ _Nonnull)(UserModel * _Nonnull))onVerificationCompleted onVerificationFailed:(void (^ _Nonnull)(NSError * _Nonnull))onVerificationFailed;
- (void)linkProviderWithCredentials:(AuthCredentials * _Nonnull)credentials completion:(void (^ _Nonnull)(UserModel * _Nullable, NSError * _Nullable))completion;
- (void)signInWithCredentialWithCredentials:(AuthCredentials * _Nonnull)credentials completion:(void (^ _Nonnull)(UserModel * _Nullable, NSError * _Nullable))completion;
- (void)sendEmailVerificationWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)updateEmailWithNewEmail:(NSString * _Nonnull)newEmail completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
@end

SWIFT_CLASS("_TtC20KFirebaseAuthInterop17UserMetaDataModel")
@interface UserMetaDataModel : NSObject
@property (nonatomic) double creationTime;
@property (nonatomic) double lastSignInTime;
- (nonnull instancetype)initWithCreationTime:(double)creationTime lastSignInTime:(double)lastSignInTime OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC20KFirebaseAuthInterop9UserModel")
...
@property (nonatomic, strong) UserMetaDataModel * _Nullable metaData;
- (nonnull instancetype)initWithUid:(NSString * _Nonnull)uid email:(NSString * _Nullable)email displayName:(NSString * _Nullable)displayName phoneNumber:(NSString * _Nullable)phoneNumber photoURL:(NSString * _Nullable)photoURL isAnonymous:(BOOL)isAnonymous isEmailVerified:(BOOL)isEmailVerified metaData:(UserMetaDataModel * _Nullable)metaData OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16 {
    uint64_t _1;
    void *_Nullable _2;
};

        static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16(char *_Nonnull result, struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16 value) {
            memcpy(result + 0, &value._1, 8);
            memcpy(result + 8, &value._2, 8);
}

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 {
    uint64_t _1;
};

        static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(const char *_Nonnull value) {
            struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 result;
            memcpy(&result._1, value + 0, 8);
            return result;
}

        SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16 $s20KFirebaseAuthInterop16ActionCodeResultO11descriptionSSvg(struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8 {
    uint64_t _1;
};

        static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8(char *_Nonnull result, struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8 value) {
            memcpy(result + 0, &value._1, 8);
}

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9 {
    uint64_t _1;
    uint8_t _2;
};

        static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9(char *_Nonnull result, struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9 value) {
            memcpy(result + 0, &value._1, 8);
            memcpy(result + 8, &value._2, 1);
}

        SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9 $s20KFirebaseAuthInterop16ActionCodeResultO8rawValueACSgSi_tcfC(ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
        SWIFT_EXTERN ptrdiff_t $s20KFirebaseAuthInterop16ActionCodeResultO8rawValueSivg(struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct KFirebaseAuthInterop_ActionCodeResult {
    _Alignas(8) char _storage[8];
};

        SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16 $s20KFirebaseAuthInterop0B8ProviderO11stringValueSSyF(struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // stringValue()
        SWIFT_EXTERN struct swift_interop_returnStub_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9 $s20KFirebaseAuthInterop0B8ProviderO8rawValueACSgSi_tcfC(ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
        SWIFT_EXTERN ptrdiff_t $s20KFirebaseAuthInterop0B8ProviderO8rawValueSivg(struct swift_interop_passStub_KFirebaseAuthInterop_uint64_t_0_8 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct KFirebaseAuthInterop_AuthProvider {
    _Alignas(8) char _storage[8];
};
...
class SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult") ActionCodeResult;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<KFirebaseAuthInterop::ActionCodeResult> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_ActionCodeResult;

// Type metadata accessor for ActionCodeResult
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s20KFirebaseAuthInterop16ActionCodeResultOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult") ActionCodeResult final {
public:
  SWIFT_INLINE_THUNK ~ActionCodeResult() noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop16ActionCodeResultOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK ActionCodeResult(const ActionCodeResult &other) noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop16ActionCodeResultOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK ActionCodeResult &operator =(const ActionCodeResult &other) noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop16ActionCodeResultOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK ActionCodeResult &operator =(ActionCodeResult &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER ActionCodeResult(ActionCodeResult &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    signInWithEmailLink SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultSignInWithEmailLink"),
    verifyEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultVerifyEmail"),
    recoverEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultRecoverEmail"),
    revertSecondFactorAddition SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultRevertSecondFactorAddition"),
    verifyBeforeChangeEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultVerifyBeforeChangeEmail")
  };

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_signInWithEmailLink {  // impl struct for case signInWithEmailLink
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::signInWithEmailLink;
    }
    SWIFT_INLINE_THUNK ActionCodeResult operator()() const;
  } signInWithEmailLink SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultSignInWithEmailLink");
  SWIFT_INLINE_THUNK bool isSignInWithEmailLink() const;

  inline const static struct _impl_verifyEmail {  // impl struct for case verifyEmail
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::verifyEmail;
    }
    SWIFT_INLINE_THUNK ActionCodeResult operator()() const;
  } verifyEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultVerifyEmail");
  SWIFT_INLINE_THUNK bool isVerifyEmail() const;

  inline const static struct _impl_recoverEmail {  // impl struct for case recoverEmail
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::recoverEmail;
    }
    SWIFT_INLINE_THUNK ActionCodeResult operator()() const;
  } recoverEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultRecoverEmail");
  SWIFT_INLINE_THUNK bool isRecoverEmail() const;

  inline const static struct _impl_revertSecondFactorAddition {  // impl struct for case revertSecondFactorAddition
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::revertSecondFactorAddition;
    }
    SWIFT_INLINE_THUNK ActionCodeResult operator()() const;
  } revertSecondFactorAddition SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultRevertSecondFactorAddition");
  SWIFT_INLINE_THUNK bool isRevertSecondFactorAddition() const;

  inline const static struct _impl_verifyBeforeChangeEmail {  // impl struct for case verifyBeforeChangeEmail
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::verifyBeforeChangeEmail;
    }
    SWIFT_INLINE_THUNK ActionCodeResult operator()() const;
  } verifyBeforeChangeEmail SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@ActionCodeResult@ActionCodeResultVerifyBeforeChangeEmail");
  SWIFT_INLINE_THUNK bool isVerifyBeforeChangeEmail() const;

#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    switch (_getEnumTag()) {
      case 0: return cases::signInWithEmailLink;
      case 1: return cases::verifyEmail;
      case 2: return cases::recoverEmail;
      case 3: return cases::revertSecondFactorAddition;
      case 4: return cases::verifyBeforeChangeEmail;
      default: abort();
    }
  }

  SWIFT_INLINE_THUNK swift::String getDescription() const SWIFT_SYMBOL("s:20KFirebaseAuthInterop16ActionCodeResultO11descriptionSSvp");
  static SWIFT_INLINE_THUNK swift::Optional<ActionCodeResult> init(swift::Int rawValue) SWIFT_SYMBOL("s:20KFirebaseAuthInterop16ActionCodeResultO8rawValueACSgSi_tcfc");
  SWIFT_INLINE_THUNK swift::Int getRawValue() const SWIFT_SYMBOL("s:20KFirebaseAuthInterop16ActionCodeResultO8rawValueSivp");
private:
  SWIFT_INLINE_THUNK ActionCodeResult() noexcept {}
  static SWIFT_INLINE_THUNK ActionCodeResult _make() noexcept { return ActionCodeResult(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }
  ...
  alignas(8) char _storage[8];
  friend class _impl::_impl_ActionCodeResult;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s20KFirebaseAuthInterop16ActionCodeResultOD;
  static inline constexpr $s20KFirebaseAuthInterop16ActionCodeResultOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_ActionCodeResult {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(ActionCodeResult &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const ActionCodeResult &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER ActionCodeResult returnNewValue(T callable) {
    auto result = ActionCodeResult::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<KFirebaseAuthInterop::ActionCodeResult> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop16ActionCodeResultOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<KFirebaseAuthInterop::ActionCodeResult> = true;
template<>
struct implClassFor<KFirebaseAuthInterop::ActionCodeResult> { using type = KFirebaseAuthInterop::_impl::_impl_ActionCodeResult; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider") AuthProvider;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<KFirebaseAuthInterop::AuthProvider> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AuthProvider;

// Type metadata accessor for AuthProvider
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s20KFirebaseAuthInterop0B8ProviderOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider") AuthProvider final {
public:
  SWIFT_INLINE_THUNK ~AuthProvider() noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop0B8ProviderOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AuthProvider(const AuthProvider &other) noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop0B8ProviderOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AuthProvider &operator =(const AuthProvider &other) noexcept {
    auto metadata = _impl::$s20KFirebaseAuthInterop0B8ProviderOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AuthProvider &operator =(AuthProvider &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AuthProvider(AuthProvider &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    google SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider@AuthProviderGoogle"),
    facebook SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider@AuthProviderFacebook")
  };

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_google {  // impl struct for case google
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::google;
    }
    SWIFT_INLINE_THUNK AuthProvider operator()() const;
  } google SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider@AuthProviderGoogle");
  SWIFT_INLINE_THUNK bool isGoogle() const;

  inline const static struct _impl_facebook {  // impl struct for case facebook
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::facebook;
    }
    SWIFT_INLINE_THUNK AuthProvider operator()() const;
  } facebook SWIFT_SYMBOL("c:@M@KFirebaseAuthInterop@E@AuthProvider@AuthProviderFacebook");
  SWIFT_INLINE_THUNK bool isFacebook() const;

#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    switch (_getEnumTag()) {
      case 0: return cases::google;
      case 1: return cases::facebook;
      default: abort();
    }
  }

  SWIFT_INLINE_THUNK swift::String stringValue() const SWIFT_SYMBOL("s:20KFirebaseAuthInterop0B8ProviderO11stringValueSSyF");
  static SWIFT_INLINE_THUNK swift::Optional<AuthProvider> init(swift::Int rawValue) SWIFT_SYMBOL("s:20KFirebaseAuthInterop0B8ProviderO8rawValueACSgSi_tcfc");
  SWIFT_INLINE_THUNK swift::Int getRawValue() const SWIFT_SYMBOL("s:20KFirebaseAuthInterop0B8ProviderO8rawValueSivp");
private:
  SWIFT_INLINE_THUNK AuthProvider() noexcept {}
  static SWIFT_INLINE_THUNK AuthProvider _make() noexcept { return AuthProvider(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }
  ...
  alignas(8) char _storage[8];
  friend class _impl::_impl_AuthProvider;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s20KFirebaseAuthInterop0B8ProviderOD;
  static inline constexpr $s20KFirebaseAuthInterop0B8ProviderOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AuthProvider {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AuthProvider &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AuthProvider &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AuthProvider returnNewValue(T callable) {
    auto result = AuthProvider::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<KFirebaseAuthInterop::AuthProvider> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop0B8ProviderOMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<KFirebaseAuthInterop::AuthProvider> = true;
template<>
struct implClassFor<KFirebaseAuthInterop::AuthProvider> { using type = KFirebaseAuthInterop::_impl::_impl_AuthProvider; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace KFirebaseAuthInterop SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("KFirebaseAuthInterop") {
  ...
  SWIFT_INLINE_THUNK ActionCodeResult ActionCodeResult::_impl_signInWithEmailLink::operator()() const {
    auto result = ActionCodeResult::_make();
    result._destructiveInjectEnumTag(0);
    return result;
  }
  SWIFT_INLINE_THUNK  bool ActionCodeResult::isSignInWithEmailLink() const {
    return *this == ActionCodeResult::signInWithEmailLink;
  }
  SWIFT_INLINE_THUNK ActionCodeResult ActionCodeResult::_impl_verifyEmail::operator()() const {
    auto result = ActionCodeResult::_make();
    result._destructiveInjectEnumTag(1);
    return result;
  }
  SWIFT_INLINE_THUNK  bool ActionCodeResult::isVerifyEmail() const {
    return *this == ActionCodeResult::verifyEmail;
  }
  SWIFT_INLINE_THUNK ActionCodeResult ActionCodeResult::_impl_recoverEmail::operator()() const {
    auto result = ActionCodeResult::_make();
    result._destructiveInjectEnumTag(2);
    return result;
  }
  SWIFT_INLINE_THUNK  bool ActionCodeResult::isRecoverEmail() const {
    return *this == ActionCodeResult::recoverEmail;
  }
  SWIFT_INLINE_THUNK ActionCodeResult ActionCodeResult::_impl_revertSecondFactorAddition::operator()() const {
    auto result = ActionCodeResult::_make();
    result._destructiveInjectEnumTag(3);
    return result;
  }
  SWIFT_INLINE_THUNK  bool ActionCodeResult::isRevertSecondFactorAddition() const {
    return *this == ActionCodeResult::revertSecondFactorAddition;
  }
  SWIFT_INLINE_THUNK ActionCodeResult ActionCodeResult::_impl_verifyBeforeChangeEmail::operator()() const {
    auto result = ActionCodeResult::_make();
    result._destructiveInjectEnumTag(4);
    return result;
  }
  SWIFT_INLINE_THUNK  bool ActionCodeResult::isVerifyBeforeChangeEmail() const {
    return *this == ActionCodeResult::verifyBeforeChangeEmail;
  }
  SWIFT_INLINE_THUNK swift::String ActionCodeResult::getDescription() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KFirebaseAuthInterop::_impl::swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16(result, KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop16ActionCodeResultO11descriptionSSvg(KFirebaseAuthInterop::_impl::swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(_getOpaquePointer())));
  });
  }
  SWIFT_INLINE_THUNK swift::Optional<ActionCodeResult> ActionCodeResult::init(swift::Int rawValue) {
  return swift::_impl::_impl_Optional<ActionCodeResult>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KFirebaseAuthInterop::_impl::swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9(result, KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop16ActionCodeResultO8rawValueACSgSi_tcfC(rawValue));
  });
  }
  SWIFT_INLINE_THUNK swift::Int ActionCodeResult::getRawValue() const {
  return KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop16ActionCodeResultO8rawValueSivg(KFirebaseAuthInterop::_impl::swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK AuthProvider AuthProvider::_impl_google::operator()() const {
    auto result = AuthProvider::_make();
    result._destructiveInjectEnumTag(0);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AuthProvider::isGoogle() const {
    return *this == AuthProvider::google;
  }
  SWIFT_INLINE_THUNK AuthProvider AuthProvider::_impl_facebook::operator()() const {
    auto result = AuthProvider::_make();
    result._destructiveInjectEnumTag(1);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AuthProvider::isFacebook() const {
    return *this == AuthProvider::facebook;
  }
  SWIFT_INLINE_THUNK swift::String AuthProvider::stringValue() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KFirebaseAuthInterop::_impl::swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_void_ptr_8_16(result, KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop0B8ProviderO11stringValueSSyF(KFirebaseAuthInterop::_impl::swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(_getOpaquePointer())));
  });
  }
  SWIFT_INLINE_THUNK swift::Optional<AuthProvider> AuthProvider::init(swift::Int rawValue) {
  return swift::_impl::_impl_Optional<AuthProvider>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    KFirebaseAuthInterop::_impl::swift_interop_returnDirect_KFirebaseAuthInterop_uint64_t_0_8_uint8_t_8_9(result, KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop0B8ProviderO8rawValueACSgSi_tcfC(rawValue));
  });
  }
  SWIFT_INLINE_THUNK swift::Int AuthProvider::getRawValue() const {
  return KFirebaseAuthInterop::_impl::$s20KFirebaseAuthInterop0B8ProviderO8rawValueSivg(KFirebaseAuthInterop::_impl::swift_interop_passDirect_KFirebaseAuthInterop_uint64_t_0_8(_getOpaquePointer()));
  }
